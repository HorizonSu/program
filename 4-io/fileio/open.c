...
int main()
{
	...
	/*fopen(FILE_PATH, "w")
	if ( -1 == (fd = open(FILE_PATH, O_CREAT | O_WRONLY | O_TRUNC , 0644)))
		ERROR("open");
	*/
	...
	*/
	...
	/*fopen(FILE_PATH, "a")
	if ( -1 == (fd = open(FILE_PATH, O_CREAT | O_WRONLY | O_APPEND , 0644)))
		ERROR("open");
	*/

	/*fopen(FILE_PATH, "a+") */
	if ( -1 == (fd = open(FILE_PATH, O_CREAT | O_RDWR | O_APPEND , 0644)))
		ERROR("open");
